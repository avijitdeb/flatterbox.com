    ...
    class WC_Multiple_Shipping extends WC_Shipping_Method {
        ...
        function generate_ms_product_select_html( $key, $data ) {
            ...
            $html .= '<tr valign="top">' . "\n";
                ...
                $html .= '<td class="forminp">' . "\n";
                    $html .= '<fieldset><legend class="screen-reader-text"><span>' . wp_kses_post( $data['title'] ) . '</span></legend>' . "\n";
                    $html .= '<select multiple="multiple" id="' . esc_attr( $this->plugin_id . $this->id . '_' . $key ) . '" name="'. esc_attr( $this->plugin_id . $this->id . '_' . $key ) .'[]" class="ajax_chosen_select_products_and_variations" multiple data-placeholder="'. __('Search for a product&hellip;', 'woocommerce') .'" style="width: 400px">';
        ...
        function generate_ms_category_select_html( $key, $data ) {
            ...
            $html .= '<tr valign="top">' . "\n";
                ...
                $html .= '<td class="forminp">' . "\n";
                    $html .= '<fieldset><legend class="screen-reader-text"><span>' . wp_kses_post( $data['title'] ) . '</span></legend>' . "\n";
                    $html .= '<select multiple="multiple" id="' . esc_attr( $this->plugin_id . $this->id . '_' . $key ) . '" name="'. esc_attr( $this->plugin_id . $this->id . '_' . $key ) .'[]" class="chzn-select" multiple data-placeholder="'. __('Select categories&hellip;', 'woocommerce') .'" style="width: 400px">';
        ...
        function save_settings( $settings ) {
            ...
            $settings['excluded_products']      = (isset($_POST['woocommerce_multiple_shipping_excluded_products'])) ? $_POST['woocommerce_multiple_shipping_excluded_products'] : array();
