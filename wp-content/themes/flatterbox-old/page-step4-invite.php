			...
			<div class="box-padding">
				...
				<div class="invite-actions">
					<?php if (strlen(get_field('unique_url', $_SESSION["new_flatterbox_id"])) > 0 ) : ?>
						<p>Share your Flatterbox with Flatterers using your unique link : <input type="text" readonly name="unique-url" id="unique-url" value="<?php echo home_url().'/?fb='.get_field('unique_url', $_SESSION["new_flatterbox_id"]); ?>"></p>
					<?php endif; ?>
				</div>
...
'; endif;
		...
		<div class="control-bar bottom">
			...
			<a href="javascript:;" class="btn back" style="padding-left:10px;" onclick="jQuery('#redirectback').val('1'); jQuery('#submitinvites').trigger('click');">Back to Personalize It</a>
