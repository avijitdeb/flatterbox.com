...
/* Template Name: Order Step 2 - Preview Order */
	...
	<div class="container">
		...
		<div class="preview">
			...
			<div class="sample">
				...
				<a href="#" class="btn">Edit Sentiments</a>
			</div>
		</div>
		<div class="divider"></div>
		<h2>Shipping Overview</h2><a href="<?php echo do_shortcode('[site_url]'); ?>/order-shipping-information/" class="btn edit">Edit Shipping Information</a>
		...
		?>
			...
			<div class="one-third">
				...
				<input type="button" class="btn" value="Edit" onClick="document.location='<?php echo do_shortcode('[site_url]'); ?>/order-shipping-information/?OID=<?php echo $Row["OID"] ?>';" />
			</div>
		...
		<div class="control-bar bottom">
			...
			<a href="<?php echo do_shortcode('[site_url]'); ?>/my-flatterbox/order-confirmation/" class="btn save">Checkout</a>
		</div>
	</div>
</main>
<?php endwhile; endif; ?>
