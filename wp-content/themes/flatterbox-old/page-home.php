...
<main id="main" role="main">
	<div class="banner">
		...
		<div class="home carousel cycle-gallery">
			...
			<a class="btn-prev trackLink" href="#" data-name="Slider previous link" data-location="homepage">Previous</a>
			<a class="btn-next trackLink" href="#" data-name="Slider next link" data-location="homepage">Next</a>
		</div>
		<?php endif; ?>
	...
	<section class="intro-block">
		...
		<div class="three-columns">
			...
			<?php if (get_sub_field('step_link')) : echo '<a href="'.home_url().get_sub_field('step_link').'" class="trackLink" data-name="Step Link" data-location="homepage" title="'.get_sub_field('step_headline').'">'; endif; ?>
			<div class="col">
...
<?php if ( $testimonials_query->have_posts() ) : ?>	
	<section class="review-block">
		...
		<a href="<?php echo do_shortcode('[site_url]'); ?>/share-your-story" class="btn-share trackLink" data-name="Share your story link" data-location="homepage">share your story</a>
	</section>
<?php endif; ?>
</main>
<?php get_footer(); ?>		
