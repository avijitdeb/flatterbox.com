		...
		<section id="sentiment-form-holder" class="sentiment-holder">
			...
			<div class="example">
				<div id="card-preview" class="img-holder blank-card">
					<span id="card-preview-text"><?php if(isset($_SESSION["sentimenttext"])) { echo $_SESSION["sentimenttext"] } else { ?>A vetri olorem sei mas nostra proin acru vetri otto viverra nec. Pdui eges congue loremi magnaiana. Praesent varium disctus alorem dei sun.<?php } ?></span>
					<span id="card-preview-name"><?php if(isset($_SESSION["sentimentname"])) { echo $_SESSION["sentimentname"] } else { ?>Your Name (or family)<?php } ?></span>
				</div>
			</div>			
		</section>
