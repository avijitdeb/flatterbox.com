...
<script>
	...
	jQuery("#input_<?php echo $iForm; ?>_25 input[value=<?php if(get_field('allow_to_see_eachother',$populatePID)){ the_field('allow_to_see_eachother',$populatePID); } else { echo "0"; } ?>]").prop("checked", true);
	jQuery("#input_<?php echo $iForm; ?>_7 input[value=<?php if(get_field('allow_to_share',$populatePID)){ the_field('allow_to_share',$populatePID); } else { echo "0"; } ?>]").prop("checked", true);
	...
	jQuery("#input_<?php echo $iForm; ?>_69 input[value=<?php if(get_field('can_invite',$populatePID)){ the_field('can_invite',$populatePID); } else { echo "0"; } ?>]").prop("checked", true);
	...
	jQuery("#input_<?php echo $iForm; ?>_75").val("<?php echo encodeData(get_field('notification_frequency',$populatePID)); ?>");
...
<script>
	...
	?>	
	jQuery("#input_<?php echo $iForm; ?>_54").val('<?php echo $sentimentdate; ?>');
	jQuery("#input_<?php echo $iForm; ?>_25 input[value=<?php if($_GET['sentim']){ echo $_GET['sentim']; } else { echo "0"; } ?>]").prop("checked", true);
	...
	jQuery("#input_<?php echo $iForm; ?>_75").val("<?php echo encodeData($_GET['summary']); ?>");
