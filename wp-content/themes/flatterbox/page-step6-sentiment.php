...
?>
		...
		<div class="control-bar bottom">
			<a href="<?php echo do_shortcode('[site_url]'); ?>/title-card/" class="btn back" onclick="gotoStep5_5();">Back to Title Card</a>
...
function htmlDecode(input){
  ...
  return e.childNodes.length === 0 ? "" : e.childNodes[0].nodeValue;
	...
	function gotoStep5_5() {
		document.location = '<?php echo do_shortcode('[site_url]'); ?>/title-card/';
	}
	jQuery(document).ready(function($) {
